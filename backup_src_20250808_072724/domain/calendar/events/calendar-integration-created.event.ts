...
export class CalendarIntegrationCreatedEvent extends DomainEvent {
  public readonly eventName = 'CalendarIntegrationCreated';
  ...
  public getEventData(): Record<string, any> {
    return {
      ...
      settings: this.calendarIntegration.settings,
    };
  }
}
