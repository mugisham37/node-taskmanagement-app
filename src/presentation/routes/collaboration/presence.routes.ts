...
export async function presenceRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  // Enhanced presence tracking routes
  fastify.put(
    '/location',
    {
      schema: {
        description: 'Update user location context',
        tags: ['Presence'],
        body: {
          type: 'object',
          properties: {
    ...
    presenceController.updateLocation.bind(presenceController)
  );
  ...
  fastify.put(
      ...
      schema: {
        ...
        body: {
          ...
          properties: {
            ...
            emoji: {
              type: 'string',
              description: 'Optional emoji for status',
            },
            expiresAt: {
              type: 'string',
              format: 'date-time',
              description: 'Optional expiry time for status',
            },
          },
        },
        response: {
    ...
    presenceController.setCustomStatus.bind(presenceController)
  );
  ...
  fastify.delete(
    ...
    {
      schema: {
        description: 'Clear custom status message',
        tags: ['Presence'],
        response: {
          200: {
            type: 'object',
    ...
    presenceController.clearCustomStatus.bind(presenceController)
  );
  ...
  fastify.get(
    ...
    {
      schema: {
        description: 'Get comprehensive resource activity summary',
        tags: ['Presence'],
        querystring: {
          type: 'object',
          required: ['resourceId'],
    ...
    presenceController.getResourceActivity.bind(presenceController)
  );
  ...
  fastify.get(
        ...
        querystring: {
          ...
          properties: {
            userId: {
              ...
              format: 'uuid',
              description:
                'User ID to get history for (defaults to current user)',
            },
            limit: {
              type: 'integer',
              minimum: 1,
    ...
    presenceController.getUserActivityHistory.bind(presenceController)
  );
  ...
  fastify.get(
    ...
    {
      schema: {
        description: 'Get enhanced presence statistics (admin only)',
        tags: ['Presence'],
        response: {
          200: {
            type: 'object',
