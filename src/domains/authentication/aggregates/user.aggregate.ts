...
export class UserRegisteredEvent extends BaseDomainEvent {
  constructor(userId: UserId, email: Email, name?: string) {
    super(userId.value, 'UserRegistered', {
      userId: userId.value,
      email: email.value,
      name,
    });
...
export class UserEmailVerifiedEvent extends BaseDomainEvent {
  constructor(userId: UserId, email: Email) {
    super(userId.value, 'UserEmailVerified', {
      userId: userId.value,
      email: email.value,
    });
  }
...
export class UserProfileUpdatedEvent extends BaseDomainEvent {
  constructor(userId: UserId, changes: Partial<UserProps>) {
    super(userId.value, 'UserProfileUpdated', {
      userId: userId.value,
      changes,
    });
  }
...
export class UserMFAEnabledEvent extends BaseDomainEvent {
  constructor(userId: UserId) {
    super(userId.value, 'UserMFAEnabled', {
      userId: userId.value,
    });
  }
}

export class UserMFADisabledEvent extends BaseDomainEvent {
  constructor(userId: UserId) {
    super(userId.value, 'UserMFADisabled', {
      userId: userId.value,
    });
  }
}
...
export class UserUnlockedEvent extends BaseDomainEvent {
  constructor(userId: UserId) {
    super(userId.value, 'UserUnlocked', {
      userId: userId.value,
    });
  }
}
...
export class UserAggregate extends AggregateRoot<UserProps> {
  ...
  public static fromPersistence(props: UserProps): UserAggregate {
